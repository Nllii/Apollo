...
if [ $? != 0 ] 
then
	echo WiFi all bad, restarting it on ${TimeDate_now} at: ${BASHTIME} 
    echo "WiFi all bad, restarting it on ${TimeDate_now} at: ${BASHTIME}"
...
/home/ubuntu/mambaforge/bin/python /home/ubuntu/Apollo/notify.py
sleep 10